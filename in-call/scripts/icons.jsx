...
const XCircle    = makeIcon(<><circle cx="12" cy="12" r="8.5" /><path d="M9 9l6 6" /><path d="M15 9l-6 6" /></>);
const Flag        = makeIcon(<><path d="M5 22V3" /><path d="M5 4h12l-2 4 2 4H5" /></>);
const Calendar   = makeIcon(<><rect x="3.5" y="5.5" width="17" height="15" rx="2" /><path d="M3.5 10h17" /><path d="M8 3v4" /><path d="M16 3v4" /></>);
const Globe      = makeIcon(<><circle cx="12" cy="12" r="8.5" /><path d="M3.5 12h17" /><path d="M12 3.5c2.5 3 2.5 14 0 17" /><path d="M12 3.5c-2.5 3-2.5 14 0 17" /></>);
const Mail       = makeIcon(<><rect x="3.5" y="5.5" width="17" height="13" rx="2" /><path d="M3.5 7l8.5 6.5L20.5 7" /></>);
const UsersIcon  = makeIcon(<><circle cx="9" cy="8" r="3.2" /><path d="M3 19a6 6 0 0 1 12 0" /><circle cx="17" cy="9" r="2.4" /><path d="M16 14a4 4 0 0 1 5 4" /></>);
...
const ZoomSyncIcons = {
  ...
  Shield, Zap, Warning, Clock, Lock, User, Grid, Layout, Send, CheckCircle, XCircle, Flag,
  Calendar, Globe, Mail, UsersIcon,
};
