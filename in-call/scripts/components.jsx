...
/* ---------------- Detection toast ----------------
   The PM-context "hey, Sync detected a task" notification.
   Big, glowy, slides down from the top — the host shouldn't miss it. */
function DetectionToast({ person, phrase, title }) {
  return (
    <div style={{
      width: "100%",
      padding: "16px 18px",
      display: "flex", alignItems: "center", gap: 14,
      background: "linear-gradient(180deg, rgba(45,140,255,0.18) 0%, rgba(139,92,246,0.20) 100%)",
      ...
      animation: "zsDetectionDrop 420ms cubic-bezier(0.22, 1, 0.36, 1), zsDetectionPulse 2.4s ease-in-out 600ms infinite",
      position: "relative",
    }}>
      <div style={{
        width: 46, height: 46, borderRadius: 12,
        background: "rgba(139,92,246,0.28)",
        color: "#C7B3FF", flex: "none",
        display: "flex", alignItems: "center", justifyContent: "center",
        position: "relative",
      }}>
        <I.Sparkle size={22} strokeWidth={2} />
        <span aria-hidden="true" style={{
          position: "absolute", inset: -6, borderRadius: 16,
          border: "1px solid rgba(139,92,246,0.5)",
          animation: "zsDetectionRipple 1.6s ease-out infinite",
        }} />
      </div>
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
          <span style={{
            ...
            <span style={{
              ...
              background: "#C7B3FF",
              boxShadow: "0 0 8px #C7B3FF",
              animation: "zsDetectionDot 1.2s ease-in-out infinite",
            }} />
            Task detected
          </span>
          {person?.name && (
            <span style={{
              fontSize: 11, fontWeight: 500, color: "var(--zs-text-md)",
            }}>
              from <span style={{ color: "var(--zs-text-hi)", fontWeight: 600 }}>{person.name}</span>
            </span>
          )}
        </div>
        {title && (
          <div style={{
            fontSize: 16, fontWeight: 700, color: "var(--zs-text-hi)",
  ...
  return (
    <header style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 600 }}>PGO-5 Prep · Weekly Sync</div>
