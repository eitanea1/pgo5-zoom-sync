...
const ATTENDEE_STREAM = [
  { title: "Pull the Q3 roadmap timeline into a one-pager",  due: "Fri, May 2",  dueInQuote: "by Friday",       destination: "asana", confidence: 0.93 },
  { title: "Audit the discovery doc with research findings", due: "Thu, May 8",  destination: "jira",          confidence: 0.81,
    trigger: "volunteered", quote: "I'll audit the discovery doc with the latest research findings." },
  { title: "Write the PRD for workspace permissions",        due: null,          dueInQuote: null,              destination: "linear", confidence: 0.89 },
  { title: "Prep the discovery readout for product review",  due: "Tue, May 6",  destination: "asana",          confidence: 0.88,
    trigger: "role_specific", quote: "Anyone want to prep the discovery readout for the product review?" },
  { title: "Define KPIs for the new analytics module",       due: "Tomorrow",    dueInQuote: "by tomorrow",     destination: "asana", confidence: 0.92 },
  { title: "Pull together the retention cohort analysis",    due: "Fri, May 2",  destination: "jira",         confidence: 0.84,
    trigger: "volunteered", quote: "I'll pull together the retention cohort analysis by end of week." },
  ...
  { title: "Draft success metrics for the onboarding redesign", due: "Fri, May 2", destination: "asana",     confidence: 0.92,
    trigger: "role_specific", quote: "Could whoever owns onboarding draft success metrics for the redesign?" },
  { title: "Refresh the roadmap deck before exec review",    due: "Wed, Apr 30", dueInQuote: "by Wednesday",    destination: "asana", confidence: 0.86 },
];
...
function buildAttendeePendingSeed(viewer) {
  ...
  const assigner1 = (others[0] && others[0].name.split(" ")[0]) || "Eitan";
  const assigner2 = (others[1] && others[1].name.split(" ")[0]) || "Neriya";
  return [
    {
      id: `a-pseed-name-${viewer.id}`,
      title: "Pull the Q3 roadmap timeline into a one-pager",
      quote: null,
      quoteParts: {
        prefix: `${firstName}, can you pull the Q3 roadmap timeline into a one-pager `,
        highlight: "by Friday",
        suffix: "?",
      },
    ...
    },
    {
      ...
      title: "Pull together the retention cohort analysis",
      quote: "I'll pull together the retention cohort analysis by end of week.",
    ...
    },
    {
      ...
      title: "Prep the discovery readout for product review",
      quote: "Anyone want to prep the discovery readout for the product review?",
...
const ATTENDEE_UNASSIGNED_SEED = [
  ...
  {
    id: "a-u-02",
    title: "Decide on the naming convention for new feature flags",
    quote: "We still need to land on a naming convention for the new feature flags.",
    speakerName: "Neriya",
    trigger: "unattributed",
    due: null,
    destination: "linear",
  ...
  {
    id: "a-u-03",
    title: "Audit competitor pricing pages for the positioning doc",
    quote: "Whoever's on positioning should give the competitor pricing pages a once-over.",
    speakerName: "Tal",
    trigger: "role_specific",
    due: "Thu, May 8",
    destination: "jira",
    ...
    <div data-screen-label="Attendee view" style={{
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <div style={{ fontSize: 13, fontWeight: 600 }}>PM Weekly Sync</div>
            <div style={{ fontSize: 11, color: "var(--zs-text-lo)" }}>
              Host: Ofir Even-Zur · You're attending as {viewer.name} · {String(Math.floor(state.elapsed / 60)).padStart(2,"0")}:{String(state.elapsed % 60).padStart(2,"0")}
            </div>
          </div>
        </div>
      ...
      <main style={{ flex: 1, minHeight: 0, display: "flex", gap: 16, padding: 16, position: "relative" }}>
